 ...
 */
@Configuration
public class MySeckillRabbitMQConfig {
     ...
     */
    @Bean
    public Queue seckillSucceedDelayQueue() {
        /*
    ...
    @Bean
    public Binding seckillSucceedDelayBinding() {
        /*
    ...
    @Bean
    public Binding seckillProcessBinding() {
        /*
         * String destination, 目的地（队列名或者交换机名字）
         * DestinationType destinationType, 目的地类型（Queue、Exhcange）
         * String exchange,
